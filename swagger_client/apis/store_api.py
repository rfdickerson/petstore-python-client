...
class StoreApi(object):
    ...
    def get_order_by_id_with_http_info(self, order_id, **kwargs):
        ...
        if 'order_id' in params and params['order_id'] > 10:
            raise ValueError("Invalid value for parameter `order_id` when calling `get_order_by_id`, must be a value less than or equal to `10`")
        if 'order_id' in params and params['order_id'] < 1:
